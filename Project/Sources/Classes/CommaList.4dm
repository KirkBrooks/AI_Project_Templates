/*  CommaList class($input: variant)
 ...
 ------------------
for managing a comma delimited list of items

$list:=cs.CommaList.new(<input>;<is unique>;<delim>)
  input: text or collection of items
  is unique: default=false; true = only allow unique items
  delim:  default=,; allows setting some other value

$list:=cs.CommaList.new("a,b,c,d")
$list:=cs.CommaList.new(["a"; "b"; "c"; "d"])

$list.addItem("new item")
$text:=$list.getList()  //  "a,b,c,d"
$item:=$list.chooseByMenu()  // selected item or ""
